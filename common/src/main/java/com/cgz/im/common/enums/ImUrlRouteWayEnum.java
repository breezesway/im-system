...
public enum ImUrlRouteWayEnum {
     ...
     * 随机
     */
    RANDOM(1,"com.cgz.im.common.route.algorithm.random.RandomHandle"),


    /**
     * 轮训
     */
    LOOP(2,"com.cgz.im.common.route.algorithm.loop.LoopHandle"),

    /**
     * 一致性哈希
     */
    CONSISTENT_HASH(3,"com.cgz.im.common.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
