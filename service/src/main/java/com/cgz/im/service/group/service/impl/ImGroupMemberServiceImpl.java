...
public class ImGroupMemberServiceImpl implements ImGroupMemberService {
    ...
    @Autowired
    ImGroupMemberService groupMemberService; //调用自己，为了事务控制，因为直接调用不会走事务
    ...
    /**
     * @param
     * @return com.cgz.im.common.ResponseVO
     ...
     * @return com.cgz.im.common.ResponseVO<com.cgz.im.service.group.model.resp.GetRoleInGroupResp>
